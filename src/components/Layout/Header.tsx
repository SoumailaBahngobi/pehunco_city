...
const arrondissements = [
    { name: 'Pehuncon Centre', description: 'Get a better understanding of your traffic', href: '/pehunco-centre', icon: ChartPieIcon },
    { name: 'Gninmasson', description: 'Speak directly to your customers', href: '/gninmasson', icon: CursorArrowRaysIcon },
    { name: 'Tobré', description: 'Your customers’ data will be safe and secure', href: '/tobre', icon: FingerPrintIcon },
]

const activiteEconomiques = [
    { name: 'Agriculture', description: 'Activité de base de la commune', href: '/agriculture', icon: ChartPieIcon },
    { name: 'Elevage', description: 'Activité seconde effectué dans la commune', href: '/elevage', icon: CursorArrowRaysIcon },
    { name: 'Pêche', description: 'Activité de peu pratiquée', href: '/peche', icon: FingerPrintIcon },
]
const callsToAction = [
    { name: 'videa de la commune', href: '#', icon: PlayCircleIcon },
    { name: 'Joindre le maire', href: '#', icon: PhoneIcon },
]
const Header = () => {
    const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
    return (
        <>
            <header className="bg-blue-900 dark:bg-gray-900">
